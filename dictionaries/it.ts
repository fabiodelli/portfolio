export const it = {
  ...
  home: {
    ...
    hero: {
      ...
      headline: 'Recupero le ore che la tua attività perde nei task ripetitivi.',
      lead: 'Costruisco soluzioni AI cucite sulla tua realtà — richieste, prenotazioni, comunicazioni multilingua — così il tempo torna a ciò che conta davvero: i tuoi clienti.',
    ...
    projects: {
      ...
      softale: {
        ...
        kpi1: { value: 'E2E', label: 'Generazione + voce' },
  ...
  softale: {
    ...
    title: 'Softale',
    lead: "Un prodotto AI end-to-end: pipeline generativa più sintesi vocale per creare audio-storie personalizzate. Non una commessa cliente — un prodotto proprio, in produzione.",
    statusLabel: 'Stato',
    status: 'In produzione · softale.app',
    settoreLabel: 'Settore',
  ...
  contact: {
    ...
    form: {
      ...
      sectorLabel: 'Settore',
      sectorOptions: ['Hospitality', 'Marmo', 'Nautica', 'Altro'] as const,
